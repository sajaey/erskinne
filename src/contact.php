...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $userconame = filter_var(trim($_POST["userconame"]), FILTER_SANITIZE_STRING);
    $usercontact = filter_var(trim($_POST["usercontact"]));
    $userposition = filter_var(trim($_POST["userposition"]), FILTER_SANITIZE_STRING);
    $usermessage = filter_var(trim($_POST["usermessage"]), FILTER_SANITIZE_STRING);
    ...
    $subject = "Erskinne :: New Message Received";
